...
const productFilterControllers = async (req, res) => {
  try {
...
//similar product controllers
const similarproductcontrollers = async (req, res) => {
  try {
...
const categoryWiseProduct = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error In Cateries Product",
    });
  }
};
...
// Payment
const braintreePaymentControllers = async (req, res) => {
  try {
